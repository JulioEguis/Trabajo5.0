...
<head>
    ...
    <!-- Añade este código en tu archivo de registro principal, por ejemplo, dentro de registro.php -->
...
<body>
    ...
    <div class="container">
        ...
        <a href="guarderia_registro.html" class="btn-registro-guarderia">Registro para Guarderías</a>
