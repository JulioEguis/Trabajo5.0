...
if (isset($_SESSION['usuario_nombre'])) {
    ...
    // Si 'usuario_nombre' no existe, puedes definir una variable $saludo vacía o manejarlo de alguna otra manera
    $saludo = ""; // Esto evitará que se muestre el saludo si no hay una sesión activa
}
?>
...
<body>
    ...
    <div class="usuario-info">
        <!-- Asegúrate de mostrar la variable $saludo solo si contiene algo -->
        <?php if ($saludo !== ""): ?>
